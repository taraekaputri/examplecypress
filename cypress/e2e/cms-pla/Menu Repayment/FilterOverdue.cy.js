describe('Filter Overdue', () => {
    ...
    cy.get(':nth-child(5) > .q-expansion-item > .q-expansion-item__container > .q-expansion-item__content > :nth-child(3) > .q-item > .q-item__section').click()

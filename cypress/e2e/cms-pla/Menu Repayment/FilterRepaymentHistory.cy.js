describe('Filter Repayment History', () => {
    it('Filter Repayment History Success', () => {
    ...
    cy.get(':nth-child(5) > .q-expansion-item > .q-expansion-item__container > .q-expansion-item__content > :nth-child(2) > .q-item').click()
